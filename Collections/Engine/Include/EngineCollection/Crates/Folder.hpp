...
class MutableFolder : public Common::MutableFolder, public Common::Folder
{
    ...
    friend class EngineFolderTests;
    friend class EnginePlaylistTests;
#endif
    ...
    mutable Optional<MutableArray<MutableSubCrate>> p_maybeSubCrates;
...
public:
    ...
    MutableFolder(Pointer<MutableCollection> inCollection,
    ...
    void setName(const String& name) override
    {
        ...
        auto newName = (*maybeParentFolder)->nextAvailableNameForFolderNamed(name);
    }
