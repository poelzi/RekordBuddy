...
public:
    ...
    inline bool operator!=(const CueMarker& other) const
    {
    ...
    {
        auto result = MutableString::stringWithFormat("CUE at %s seconds", this->positionInSeconds().asString().asUTF8());
...
class MutableCueMarker : public CueMarker
{
protected:
...
public:
    // -- Constructors & Destructors
    virtual ~MutableCueMarker() = default;
