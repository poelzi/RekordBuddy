...
protected:
    ...
    {
        this->p_pcdjMarker.p_marker.setColor(maybeColor.isValid() ?
...
public:
    ...
    MutableCueMarker(const DecimalNumber& positionInSeconds, const Protected&) : p_pcdjMarker{ positionInSeconds } { }
    ...
    // -- Instance Methods
    inline const PCDJ::CueMarker& asImmutableReference() const
    {
