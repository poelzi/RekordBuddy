...
protected:
    ...
    {
        this->p_pcdjMarker.p_marker.setBeatsPerMinute(bpm);
    }
...
public:
    ...
    MutableGridMarker(const DecimalNumber& positionInSeconds,
                      ...
                      const Protected&) : p_pcdjMarker{ positionInSeconds, beatsPerMinute } { }
    MutableGridMarker(MutableXMLNode xmlNode,
                      const Protected&) : p_pcdjMarker{ xmlNode.maybeDecimalValueForAttributeNamed("Inizio").valueOr(DecimalNumber{ }),
                                                             xmlNode.maybeDecimalValueForAttributeNamed("Bpm").valueOr(DecimalNumber::withInteger(123)) }
    {
        ...
        this->p_pcdjMarker.p_marker.setBeatNumber(beatNumber);
    }
    ...
    {
        return this->p_pcdjMarker.beatNumber();
    }

    DecimalNumber beatsPerMinute() const override
    {
        return this->p_pcdjMarker.beatsPerMinute();
    }
    ...
    {
        this->p_pcdjMarker.p_marker.setBeatNumber(number);
    }

    // -- Instance Methods
    inline const PCDJ::GridMarker& asImmutableReference() const
    {
