...
protected:
    ...
    mutable MutableXMLNode p_pcdjFolder;
...
public:
    ...
    {
        return this->p_pcdjFolder.maybeStringValueForAttributeNamed("name").valueOr("<No Name>"_String);
    }
    void setName(const String& name) override
    {
        ...
        this->p_pcdjFolder.setStringValueForAttributeNamed((*maybeParentFolder)->nextAvailableNameForFolderNamed(name), "name");
    }
