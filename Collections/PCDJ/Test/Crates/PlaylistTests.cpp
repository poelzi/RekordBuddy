...
class PCDJPlaylistTests : public NxA::Test
{
public:
    // -- Instance Variables
    ...
    PCDJPlaylistTests() : mockCollection{ MockMutableCollection::strickMockMutableCollectionWith(NXA_FILEPATH("My/Test/File.xml")) } { }
...
TEST_F(PCDJPlaylistTests, collection_APlaylist_ReturnsOurMockedCollection)
{
    // -- Given.
...
TEST_F(PCDJPlaylistTests, lastModificationTime_APlaylist_ReturnsTheCorrectModificationDate)
{
    // -- Given.
    auto playlist = this->testPlaylist();
...
TEST_F(PCDJPlaylistTests, name_APlaylist_ReturnsTheCorrectName)
{
    // -- Given.
    auto playlist = this->testPlaylist();
...
TEST_F(PCDJPlaylistTests, path_APlaylist_ReturnsTheCorrectPath)
{
    // -- Given.
    auto playlist = this->testPlaylist();
...
TEST_F(PCDJPlaylistTests, path_APlaylistInsideAFolder_ReturnsTheCorrectPath)
{
    // -- Given.
...
TEST_F(PCDJPlaylistTests, numberOfTracks_APlaylistWithTracksUnknownInTheCollection_ReturnsNothing)
{
    // -- Given.
...
TEST_F(PCDJPlaylistTests, numberOfTracks_APlaylist_ReturnsTheCorrectNumberOfTracks)
{
    // -- Given.
...
TEST_F(PCDJPlaylistTests, trackAtIndex_APlaylist_ReturnsTheCorrectTrack)
{
    // -- Given.
    auto mockTrack1 = MockMutableTrack::strictTrackMockInCollectionWithTrackID(this->mockCollection.asRawPointer(), 7);
    auto mockTrack2 = MockMutableTrack::strictTrackMockInCollectionWithTrackID(this->mockCollection.asRawPointer(), 8);
