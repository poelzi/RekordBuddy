...
// -- This class mocks a PCDJ MutableTrack
class MockMutableTrack : public MutableTrack
{
    ...
    MockMutableTrack(MutableXMLNode trackNode,
                     NotNull<MutableCollection*> inCollection) : MutableTrack(trackNode,
                                                                              inCollection,
                                                                              PCDJ::MutableTrack::p_isProtected),
...
public:
    ...
    MOCK_CONST_METHOD0(trackFilePathAsUsedInPCDJPlaylistEntries, String());
    MOCK_CONST_METHOD0(maybeTrackID, Optional<count>());
    MOCK_CONST_METHOD0(asImmutableReference, PCDJ::MutableTrack&());
};
