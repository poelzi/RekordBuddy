...
#include <StubCollection/Stub.hpp>
...
count approximateNumberOfAvailableStubCollections()
{
...
Array<Common::CollectionOfSomeSort> availableStubCollectionsWithPerCollectionProgressCallBack(const std::function<void(void)>& callback)
{
