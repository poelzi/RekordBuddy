...
class MutableCollection : public Common::MutableCollection, public Common::Collection
{
    ...
    NotNull<Stub::MutableFolder*> p_rootFolder() const;
    NotNull<Stub::MutableAllTracksPlaylist*> p_tracks() const;
...
public:
    ...
    {
        return "Preferences/Stub/Stub 256";
    }
    Common::Collection::Type type() const override
    {
        return Common::Collection::Type::Stub;
    }
