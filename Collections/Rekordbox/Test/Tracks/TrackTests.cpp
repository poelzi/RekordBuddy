...
class RekordboxTrackTests : public NxA::Test
{
public:
    // -- Class Methods
    static MutableXMLNode xmlNodeFrom(MutableTrack& track)
    {
        return track.p_rekordboxTrack;
    }
    ...
    RekordboxTrackTests() : mockCollection{ MockMutableCollection::strickMockMutableCollectionWith(NXA_FILEPATH("My/Test/File.xml")) }
    {
    ...
    MutableXMLNode& trackNode(Optional<String> maybeOtherVolumeName = nothing)
    {
        this->maybeNode = MutableXMLNode::maybeWithString(
                ...
                // -- The way Rekordbox encode volumes on Windows may differ from this. TBD.
...
TEST_F(RekordboxTrackTests, collection_AConstTrack_ReturnsOurMockedCollection)
{
    // -- Given.
...
TEST_F(RekordboxTrackTests, collection_ATrack_ReturnsOurMockedCollection)
{
    // -- Given.
...
TEST_F(RekordboxTrackTests, volume_AConstTrackOnTheBootVolume_ReturnsTheCorrectVolume)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, volume_ATrackOnTheBootVolume_ReturnsTheCorrectVolume)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, volume_AConstTrackNotOnTheBootVolume_ReturnsTheCorrectVolume)
{
    // -- Given.
#if defined(NXA_PLATFORM_WINDOWS)
...
TEST_F(RekordboxTrackTests, volume_ATrackNotOnTheBootVolume_ReturnsTheCorrectVolume)
{
    // -- Given.
#if defined(NXA_PLATFORM_WINDOWS)
    auto& track = this->testTrack("J:"_String).asReference();
...
TEST_F(RekordboxTrackTests, relativeFilePath_AConstTrackOnTheBootVolume_ReturnsTheCorrectFilePath)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
    ...
    // -- Then.
#if defined(NXA_PLATFORM_WINDOWS)
    // -- This returned value is probably not correct but the Windows side of Rekordbox support is still TBD at this point.
...
TEST_F(RekordboxTrackTests, relativeFilePath_ATrackOnTheBootVolume_ReturnsTheCorrectFilePath)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
    ...
    // -- Then.
#if defined(NXA_PLATFORM_WINDOWS)
    // -- This returned value is not correct but the Windows side of Rekordbox support is still TBD at this point.
    EXPECT_STREQ(result.asEncodedString().asUTF8(), "Users/didier/Music/Gigs/03 Soulmutation4.aif");
#elif defined(NXA_PLATFORM_MACOS)
    EXPECT_STREQ(result.asEncodedString().asUTF8(), "Users/didier/Music/Gigs/03 Soulmutation4.aif");
#else
...
TEST_F(RekordboxTrackTests, relativeFilePath_AConstTrackNotOnTheBootVolume_ReturnsTheCorrectFilePath)
{
    // -- Given.
#if defined(NXA_PLATFORM_WINDOWS)
    auto& track = this->testTrack("J:"_String).asReference();
...
TEST_F(RekordboxTrackTests, relativeFilePath_ATrackNotOnTheBootVolume_ReturnsTheCorrectFilePath)
{
    // -- Given.
#if defined(NXA_PLATFORM_WINDOWS)
    auto& track = this->testTrack("J:"_String).asReference();
...
TEST_F(RekordboxTrackTests, lastModificationTime_AConstTrack_ReturnsTheTrackModificationTime)
{
    // -- Given.
...
TEST_F(RekordboxTrackTests, lastModificationTime_ATrack_ReturnsTheTrackModificationTime)
{
    // -- Given.
    auto maybeModificationTimeInXMLSource = Time::maybeTimeFromStringInLocalTimeZoneUsingFormat("1981-10-22 02:16:40", Time::defaultStringFormat);
    ASSERT_TRUE(maybeModificationTimeInXMLSource.isValid());
...
TEST_F(RekordboxTrackTests, maybeTitle_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeTitle_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setTitle_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setTitle_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeAlbum_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeAlbum_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setAlbum_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setAlbum_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeComments_AConstTrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeComments_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setComments_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setComments_ATrackAndANewValueThatIsOver1000Characters_SetsTheValueButCroppedTo1000Characters)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setComments_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeAlbumTrackCount_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeAlbumTrackCount_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setAlbumTrackCount_ATrackAndANewValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setAlbumTrackCount_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, genres_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, genres_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setGenres_ATrackAndNewValues_SetsTheCorrectValues)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setGenres_ATrackAndNoValues_SetsTheValuesToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeGrouping_AConstTrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeGrouping_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setGrouping_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setGrouping_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeMixName_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeMixName_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setMixName_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setMixName_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeDateAdded_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeDateAdded_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setDateAdded_ATrackAndANewValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setDateAdded_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeDateReleased_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeDateReleased_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setDateReleased_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setReleaseDate_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeRecordLabel_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeRecordLabel_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setRecordLabel_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setRecordLabel_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, tags_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, tags_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setTags_ATrackAndNewValues_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setTags_ATrackAndNoValues_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, artists_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, artists_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setArtists_ATrackAndNewValues_SetsTheCorrectValues)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
    Array<String> newValues{ String{ "Êewïòerこれは日本語のテキストです。読めますか" }, String{ "toto" }, String{ "laricot" } };
...
TEST_F(RekordboxTrackTests, setArtists_ATrackAndNoValues_SetsTheValuesToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, producers_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, producers_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setProducers_ATrackAndNewValues_SetsTheCorrectValues)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
    Array<String> newValues{ String{ "Êewïòerこれは日本語のテキストです。読めますか" }, String{ "toto" }, String{ "laricot" } };
...
TEST_F(RekordboxTrackTests, setProducers_ATrackAndNoValues_SetsTheValuesToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, remixers_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, remixers_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setRemixers_ATrackAndNewValues_SetsTheCorrectValues)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
    Array<String> newValues{ String{ "Êewïòerこれは日本語のテキストです。読めますか" }, String{ "toto" }, String{ "laricot" } };
...
TEST_F(RekordboxTrackTests, setRemixers_ATrackAndNoValues_SetsTheValuesToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBeatGridLocked_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBeatGridLocked_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setBeatGridLocked_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBitDepthInBits_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBitDepthInBits_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setBitDepthInBits_ATrackAndANewValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setBitDepthInBits_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBitRateInKiloBitsPerSecond_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBitRateInKiloBitsPerSecond_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setBitRateInKiloBitsPerSecond_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setBitRateInKiloBitsPerSecond_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBeatsPerMinute_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeBeatsPerMinute_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setBeatsPerMinute_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setBeatsPerMinute_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeColor_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeColor_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setColor_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setColor_ATrackAndANewValueThatIsNotSupportedByRekordbox_SetsTheValuesToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setColor_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeFileSizeInBytes_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeFileSizeInBytes_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setFileSizeInBytes_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setFileSizeInBytes_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, fileType_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, fileType_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setFileType_ATrackAndANewValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, musicalKeys_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, musicalKeys_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setMusicalKeys_ATrackAndNewValues_SetsTheCorrectValues)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setMusicalKeys_ATrackAndNoValues_SetsTheValuesToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeLengthInSeconds_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeLengthInSeconds_ATrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setLength_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setLength_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeTrackNumber_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeTrackNumber_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setTrackNumber_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setTrackNumber_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeDiscNumber_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeDiscNumber_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setDiscNumber_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setDiscNumber_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybePlayCount_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybePlayCount_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setPlayCount_ATrackAndANewValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setPlayCount_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeRating_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeRating_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setRating_ATrackAndANewValue_SetsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setRating_ATrackAndNoValue_SetsTheValueToNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeSampleRateInHertz_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, maybeSampleRateInHertz_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setSampleRateInHertz_ATrackAndANewValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setSampleRateInHertz_ATrackAndNoValue_SetsNothing)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, numberOfMarkers_AConstTrack_ReturnsTheCorrectValue)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, numberOfMarkers_ATrack_ReturnsTheCorrect)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, markerAtIndex_AConstTrack_ReturnsTheCorrectMarker)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, markerAtIndex_ATrack_ReturnsTheCorrectMarker)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
    ASSERT_EQ(track.numberOfMarkers(), 6u);
...
TEST_F(RekordboxTrackTests, markerAtIndex_AConstTrackButAMaxOfNoGridMarkers_ReturnsNoGridMarkers)
{
    // -- Given.
...
TEST_F(RekordboxTrackTests, markerAtIndex_ATrackButAMaxOfNoGridMarkers_ReturnsNoGridMarkers)
{
    // -- Given.
    this->mockCollection->setTestMaximumNumberOfGridMarkersToImport(0);
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, markers_AConstTrack_ReturnsTheCorrectMarkers)
{
    // -- Given.
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, markers_ATrack_ReturnsTheCorrectMarkers)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, markers_AConstTrackButAMaxOfNoGridMarkers_ReturnsNoGridMarkers)
{
    // -- Given.
    this->mockCollection->setTestMaximumNumberOfGridMarkersToImport(0);
    auto& track = this->testConstTrack().asReference();
...
TEST_F(RekordboxTrackTests, markers_ATrackButAMaxOfNoGridMarkers_ReturnsNoGridMarkers)
{
    // -- Given.
    this->mockCollection->setTestMaximumNumberOfGridMarkersToImport(0);
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, appendCueMarker_ATrack_AddsTheCueMarker)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, appendGridMarker_ATrack_AddsTheGridMarker)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, appendLoopMarker_ATrack_AddsTheLoopMarker)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, removeMarkerAtIndex_ATrack_TheCorrectMarkerIsRemoved)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setMarkersAndMaybeAddOffsetInSeconds_ATrackAndNewMarkers_SetsTheMarkersCorrectly)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
...
TEST_F(RekordboxTrackTests, setMarkersAndMaybeAddOffsetInSeconds_ATrackNewMarkersAndResettingTheMarkersCache_SetsAndReReadsTheMarkersCorrectly)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
    MutableArray<Common::MarkerOfSomeSort> newMarkers;
    ...
    RekordboxTrackTests::clearMarkerCacheFor(track);
...
TEST_F(RekordboxTrackTests, setMarkersAndMaybeAddOffsetInSeconds_ATrackAndNewMarkersWithAnOffsetValue_SetsTheMarkersCorrectly)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
    MutableArray<Common::MarkerOfSomeSort> newMarkers;
...
TEST_F(RekordboxTrackTests, setMarkersAndMaybeAddOffsetInSeconds_ATrackNewMarkersWhenExportingHotCuesAlsoAsMemoryCues_SetsHotCuesAlsoAsMemoryCues)
{
    // -- Given.
...
TEST_F(RekordboxTrackTests, setMarkersAndMaybeAddOffsetInSeconds_ATrackNewMarkersWhenOnlyExportingOneHotCue_SetsOnlyOneHotCue)
{
    // -- Given.
    this->mockCollection->setTestExportHotCuesAlsoAsMemoryCues(true);
...
TEST_F(RekordboxTrackTests, setMarkersAndMaybeAddOffsetInSeconds_ATrackNewMarkersWhenExportingNoHotCues_SetsNoHotCues)
{
    // -- Given.
...
TEST_F(RekordboxTrackTests, setWithSamePropertiesAs_ATrackAndAnotherTrack_SetsAllPropertiesOfTheMutableTrackCorrectly)
{
    // -- Given.
    auto& track = this->testTrack().asReference();
