...
// -- This class mocks a Rekordbox MutableTrack
class MockMutableTrack : public MutableTrack
{
    ...
    MockMutableTrack(MutableXMLNode trackNode,
                     NotNull<MutableCollection*> inCollection) : MutableTrack(trackNode,
                                                                              inCollection,
                                                                              Rekordbox::MutableTrack::p_isProtected),
                                                                 p_trackNode{ std::move(trackNode) } { }

public:
    // -- Factory Methods
    static Unique<StrictMockMutableTrack> strictTrackMockInCollectionWithTrackID(NotNull<StrictMockMutableCollection*> inCollection,
                                                                                 count trackID)
    {
        ...
        NXA_DEFAULT_RETURN_ON_CALL(*track, maybeTrackID(), trackID);
        ...
        NXA_DEFAULT_RETURN_ON_CALL(*inCollection,
                                   maybeExistingTrackForTrackID(trackID),
                                                                                          ...
                                                                                          String absoluteFilePath)
    {
        ...
        auto newTrackID = inCollection->nextTestTrackID();
        ...
        NXA_DEFAULT_RETURN_ON_CALL(*track, collection(), inCollection);
        NXA_DEFAULT_RETURN_ON_CALL(*track, maybeTrackID(), newTrackID);
        ...
        NXA_DEFAULT_RETURN_ON_CALL(*inCollection,
                                   ...
                                   Optional<NotNull<Common::MutableTrack*>>{ track.asRawPointer() });
        NXA_DEFAULT_RETURN_ON_CALL(*inCollection,
                                   maybeExistingTrackForTrackID(newTrackID),
                                   Optional<NotNull<Common::MutableTrack*>>{ track.asRawPointer() });
        NXA_DEFAULT_RETURN_ON_CALL(*NotNull<const StrictMockMutableCollection*>{ inCollection },
                                   maybeExistingTrackForTrackID(newTrackID),
                                   Optional<NotNull<const Common::Track*>>{ track.asRawPointer() });
    ...
    MOCK_CONST_METHOD0(trackFilePathAsUsedInRekordboxPlaylistEntries, String());
    MOCK_CONST_METHOD0(maybeTrackID, Optional<count>());
    MOCK_CONST_METHOD0(asImmutableReference, Rekordbox::MutableTrack&());
};
