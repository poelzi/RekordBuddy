...
class RekordboxFolderTests : public NxA::Test
{
public:
    // -- Class Methods
    static MutableXMLNode xmlValueFor(const MutableFolder& folder)
    {
        return folder.p_rekordboxFolder;
    }
    ...
    RekordboxFolderTests() : mockCollection{ MockMutableCollection::strickMockMutableCollectionWith(NXA_FILEPATH("My/Test/File.xml")) } { }
...
TEST_F(RekordboxFolderTests, collection_AConstFolder_ReturnsOurMockedCollection)
{
    // -- Given.
...
TEST_F(RekordboxFolderTests, collection_AFolder_ReturnsOurMockedCollection)
{
    // -- Given.
...
TEST_F(RekordboxFolderTests, maybeParentFolder_ConstFolderWithoutAParent_ReturnsNothing)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, maybeParentFolder_AFolderWithoutAParent_ReturnsNothing)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, maybeParentFolder_ASubcrateOfAConstFolder_ReturnsTheFolder)
{
    // -- Given.
...
TEST_F(RekordboxFolderTests, maybeParentFolder_ASubcrateOfAFolder_ReturnsTheFolder)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, canBeCloned_AFolder_ReturnsFalse)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, lastModificationTime_AConstFolder_ReturnsTheCorrectModificationDate)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, lastModificationTime_AFolder_ReturnsTheCorrectModificationDate)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, name_AConstFolder_ReturnsTheCorrectName)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, name_AFolder_ReturnsTheCorrectName)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, setName_AFolder_SetsTheCorrectName)
{
    // -- Given.
    auto folder = this->testFolder();
    auto subCrate = get<NotNull<Common::MutableFolder*>>(folder.subCrateAtIndex(1));
...
TEST_F(RekordboxFolderTests, setName_AFolderAndANameThatAlreadyExists_SetsTheNextBestNameAvailable)
{
    // -- Given.
    auto folder = this->testFolder();
    auto subCrate = get<NotNull<Common::MutableFolder*>>(folder.subCrateAtIndex(1));
...
TEST_F(RekordboxFolderTests, setName_AFolderAndTheSameName_DoesNothing)
{
    // -- Given.
    auto folder = this->testFolder();
    auto subCrate = get<NotNull<Common::MutableFolder*>>(folder.subCrateAtIndex(1));
...
TEST_F(RekordboxFolderTests, cratePathFor_AConstFolder_ReturnsTheCorrectPath)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, cratePathFor_AConstFolderInsideAFolder_ReturnsTheCorrectPath)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, cratePathFor_AFolder_ReturnsTheCorrectPath)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, cratePathFor_AFolderInsideAFolder_ReturnsTheCorrectPath)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
...
TEST_F(RekordboxFolderTests, tracks_AConstFolder_ReturnsTheCorrectTracks)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, tracks_AFolder_ReturnsTheCorrectTracks)
{
    // -- Given.
    auto folder = this->testFolder();
    auto mockTrack1 = MockMutableTrack::strictTrackMockInCollectionWithTrackID(this->mockCollection.asRawPointer(), 10);
...
TEST_F(RekordboxFolderTests, numberOfSubCrates_AConstFolder_ReturnsTheCorrectNumberOfSubCrates)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, numberOfSubCrates_AFolder_ReturnsTheCorrectNumberOfSubCrates)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, subCrateAtIndex_AConstFolder_ReturnsTheCorrectSubCrates)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
...
TEST_F(RekordboxFolderTests, subCrateAtIndex_AFolder_ReturnsTheCorrectSubCrates)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
...
TEST_F(RekordboxFolderTests, addSubCrateAtIndexAsCopyOf_AFolderAndACrateWhichDoesNotAlreadyExist_AddsTheSubCrateAtTheRightIndex)
{
    // -- Given.
...
TEST_F(RekordboxFolderTests, addSubCrateAtIndexAsCopyOf_AFolderAndAnImmutableCrateWhichAlreadyExists_AddsTheSubCrateAtTheRightIndexWithAnDifferentName)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, addSubCrateAtIndexAsCopyOf_AFolderAndAMutableCrateWhichAlreadyExists_AddsTheSubCrateAtTheRightIndexWithAnDifferentName)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, addSubCrateAtIndexAsCopyOf_AFolderAndACrateWhichAlreadyExistsButWithADifferentType_AddsTheSubCrateAtTheRightIndexWithAnDifferentName)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, addSubCrateAtIndexAsCopyOf_AFolderAndACrateWhichAlreadyExistsButWithADifferentTypeIndexAfterTheExistingCrate_AddsTheSubCrateAtTheRightIndexWithAnDifferentName)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, maybeIndexOfExistingSubCrateWithSameNameAs_AFolderWithACrateOfTheSameNameButADifferentType_ReturnsTheIndex)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, maybeIndexOfExistingSubCrateWithSameNameAs_AFolderWithACrateOfTheSameNameAndSameType_ReturnsTheIndex)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, maybeIndexOfExistingSubCrateWithSameNameAs_AFolderWithNoCrateOfTheSameName_ReturnsNothing)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, moveSubCrateToIndex_AFolderWithACrateInTheSameFolder_MovesTheCrateCorrectly)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, moveSubCrateToIndex_AFolderWithACrateInADifferentFolder_MovesTheCrateCorrectly)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, moveSubCrateToIndex_AFolderWithACrateFromADifferentColleciton_Asserts)
{
    // -- Given.
    auto folder = this->testFolder();
...
TEST_F(RekordboxFolderTests, removeSubCrateAtIndex_AFolder_RemovesTheCorrectSubCrate)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
    ...
    EXPECT_EQ(RekordboxFolderTests::xmlValueFor(folder), *MutableXMLNode::maybeWithString("<NODE Name=\"And More\" Type=\"0\" Count=\"2\">"
                                                                                          "  <NODE Name=\"Inside\" Type=\"1\" KeyType=\"0\" Entries=\"2\">"
                                                                                          "    <TRACK Key=\"10\"/>"
                                                                                          "    <TRACK Key=\"12\"/>"
                                                                                          "  </NODE>"
...
TEST_F(RekordboxFolderTests, removeAllSubCrates_AFolder_RemovesAllSubCrates)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
    ...
    EXPECT_EQ(RekordboxFolderTests::xmlValueFor(folder), *MutableXMLNode::maybeWithString("<NODE Name=\"And More\" Type=\"0\" Count=\"0\"/>"));
}

TEST_F(RekordboxFolderTests, newPlaylistWithName_AFolder_AddsANewPlaylist)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
...
TEST_F(RekordboxFolderTests, newFolderWithName_AFolder_AddsANewFolder)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
...
TEST_F(RekordboxFolderTests, newPlaylistWithNameAtIndex_AFolder_AddsANewPlaylistAtTheRightSpot)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
...
TEST_F(RekordboxFolderTests, newFolderWithNameAtIndex_AFolder_AddsANewFolderAtTheRightSpot)
{
    // -- Given.
    auto folder = this->testFolder();
    ASSERT_EQ(folder.numberOfSubCrates(), 3u);
...
TEST_F(RekordboxFolderTests, canReceive_AConstFolderAndASourceCrate_ReturnsTrue)
{
    // -- Given.
    auto&& folder = this->testConstFolder();
...
TEST_F(RekordboxFolderTests, setWithSameSubCratesAsWithPerItemProgressCallBack_AFolderAndASourceCrateWhenUpdatingTracks_SetsTheFolderWithCopiesOfTheSubScratesAndUpdateTheTracks)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
...
TEST_F(RekordboxFolderTests, setWithSameSubCratesAsWithPerItemProgressCallBack_AFolderAndASourceCrateWhenNotUpdatingTracks_SetsTheFolderWithCopiesOfTheSubScratesAndDoesNotUpdateTheTracks)
{
    // -- Given.
    auto otherCollection = Common::MockCollection::strickMockCollectionWith(Volume{ FilePath{ VOLUME_TEST_PATH ""_String } },
                                                                            "Other Collection"_String,
