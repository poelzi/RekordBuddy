...
FilePath::FilePath(const String& pathAsString, CaseSensitivity caseSensitivity) : p_declaredCaseSensitivity{ caseSensitivity }
{
    ...
    this->p_setCaseSensitivityIfUnknown();
}
